...
var AddSpace = function (_Component) {
  ...
  function AddSpace(props) {
    ...
    _this.checkName = function (rule, value, callback) {
      ...
      _boot.axios.get('/wiki/v1/projects/' + AppState.currentMenuType.projectId + '/space/check?name=' + value).then(function (res) {
        if (res.failed) {
    ...
    value: function handleOk(e) {
      ...
      this.props.form.validateFields(function (err, values) {
        if (!err) {
          ...
          _boot.axios.post('/wiki/v1/projects/' + AppState.currentMenuType.projectId + '/space', component).then(function (datas) {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          _boot.Content,
          {
            ...
            description: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'wiki.create.project.description' })
          },
          _react2['default'].createElement(
            _form2['default'],
            { style: { width: 512 } },
