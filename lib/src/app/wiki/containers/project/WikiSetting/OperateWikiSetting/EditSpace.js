...
var EditSpace = function (_Component) {
  ...
  (0, _createClass3['default'])(EditSpace, [{
    ...
    value: function loadComponent(componentId) {
      ...
      _boot.axios.get('/wiki/v1/projects/' + AppState.currentMenuType.projectId + '/space/' + componentId).then(function (res) {
        var icon = res.icon,
            path = res.path,
            name = res.name;
    ...
    value: function handleOk(e) {
      ...
      this.props.form.validateFields(function (err, values) {
        if (!err) {
          ...
          _boot.axios.put('/wiki/v1/projects/' + AppState.currentMenuType.projectId + '/space/' + component.id, component).then(function (datas) {
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(
            ...
            _react2['default'].createElement(
              ...
              })(_react2['default'].createElement(_input2['default'], { disabled: true, label: _react2['default'].createElement(_reactIntl.FormattedMessage, { id: 'wiki.space.name' }), ss: true }))
            )
          )
        )
      );
