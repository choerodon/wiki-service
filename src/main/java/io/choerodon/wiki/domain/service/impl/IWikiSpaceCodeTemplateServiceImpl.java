...
public class IWikiSpaceCodeTemplateServiceImpl implements IWikiSpaceCodeTemplateService {
    ...
    @Override
    public int createSpace1CodeTemplate(String param1, String xmlParam) {
        Response<ResponseBody> response = null;
        try {
            RequestBody requestBody = RequestBody.create(MediaType.parse("Content-Type, application/xml"), xmlParam);
            response = wikiClient.createSpace1Template(
    ...
    @Override
    public int createSpace2CodeTemplate(String param1, String param2, String xmlParam) {
        Response<ResponseBody> response = null;
        try {
            RequestBody requestBody = RequestBody.create(MediaType.parse("Content-Type, application/xml"), xmlParam);
            response = wikiClient.createSpace2Template(
    ...
    @Override
    public int createSpace3CodeTemplate(String param1, String param2, String param3, String xmlParam) {
        Response<ResponseBody> response = null;
        try {
            RequestBody requestBody = RequestBody.create(MediaType.parse("Content-Type, application/xml"), xmlParam);
            response = wikiClient.createSpace3Template(
