...
class IWikiSpaceWebPreferencesServiceImplSpec extends Specification {
    ...
    void setup() {
        ...
        service = new IWikiSpaceWebPreferencesServiceImpl(wikiClient,wikiSpaceRepository)
    }

    def 'createSpace1WebPreferences'() {
        when: ''
        service.createSpace1WebPreferences(1, "2", "3","4")
    ...
    def 'createSpace2WebPreferences'() {
        when: ''
        service.createSpace2WebPreferences(1, "2", "3", "4","5")
    ...
    def 'createSpace3WebPreferences'() {
        when: ''
        service.createSpace3WebPreferences(1, "2", "3", "4", "5","6")
